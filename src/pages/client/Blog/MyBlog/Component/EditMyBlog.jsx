...
function EditMyBlog() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await updateMyBlog(id, payload);
            toast.success(res.data.message || 'Cập nhật thành công');
            navigate(`/my-blog/detail/${id}`);
        } catch (error) {
            console.error(error);
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="edit-section">
                                    <div className="d-flex justify-content-end align-items-center">
                                        <button type="submit" className="btn btn-primary me-3" disabled={loadingSubmit}>
                                            {loadingSubmit && <i className="fas fa-spinner fa-spin me-2"></i>}
                                            Lưu thay đổi
                                        </button>

                                        <Link to={`/my-blog/detail/${id}`} className="btn btn-outline-secondary">
                                            Hủy bỏ
                                        </Link>
                                    </div>
                                </div>
