    ...
    return (
        <div className="container-fluid">
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Link to="create-role-permission" className="btn btn-primary">
                            ...
                            {displayedPermissions.length === 0 ? (
                                ...
                                displayedPermissions.map((permission) => (
                                    <tr key={permission.id_quyen}>
                                        ...
                                        <td>
                                            {permission.thoi_gian_tao
                                                ? format(new Date(permission.thoi_gian_tao), 'dd/MM/yyyy HH:mm:ss', {
                                                      locale: vi,
                                                  })
                                                : ''}
                                        </td>
                                        <td>
                                            {permission.thoi_gian_cap_nhat
                                                ? format(
                                                      new Date(permission.thoi_gian_cap_nhat),
                                                      'dd/MM/yyyy HH:mm:ss',
                                                      {
                                                          locale: vi,
                                                      },
