                    ...
                    <div className="card mb-4">
                        ...
                        <div className="card-body">
                            <div className="row g-3">
                                ...
                                <div className="col-12">
                                    <label className="form-label fw-bold text-muted">Đáp án đúng</label>
                                    <div>
                                        <span
                                            className="badge bg-success fs-6 d-inline-flex align-items-center justify-content-center"
                                            style={{ width: '32px', height: '32px' }}
                                        >
                                            {questionData?.dap_an_dung}
                                        </span>
                                    </div>
                                </div>
                            </div>
